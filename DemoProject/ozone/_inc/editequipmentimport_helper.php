 <?php 
   if (($_SESSION['logged_in_user_type'] == 'admin') || ($_SESSION['logged_in_user_type'] == 'officer')) {
    ...
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		<form role="form" action="_scripts/editequipmentimport_scr.php?edit=<?php echo $_GET['edit']; ?>"  method="post" enctype="application/x-www-form-urlencoded" name="register">
			<h2>Edit Equipment Import Record | <a href="?equipment=yes">Cancel</a> </h2>
			<hr class="colorgraph">
		  ...
		  <div class="row">
				...
				<div class="col-xs-12 col-sm-4 col-md-4">
					<div class="form-group">
                        ...
                        <option value="<?php echo $edit['month']; ?>"><?php echo $edit['month']; ?></option>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    ...
                    <label>Equipment</label>
                        ...
                        <option value="<?php echo $edit['equipment']; ?>"><?php echo $edit['equipment']; ?></option>
                          <?php 
            ...
            <div class="row">
				...
				<select type="text" name="refrigerant" id="refrigerant" class="form-control input-lg" tabindex="5">
                	<option value="<?php echo $edit['refrigerant']; ?>"><?php echo $edit['refrigerant']; ?></option>
                    <?php 
				...
				<input type="text" name="quantity" id="quantity" class="form-control input-lg" value="<?php echo $edit['quantity']; ?>" tabindex="6">
					</div>
            	</div>
                
                <div class="col-xs-12 col-sm-4 col-md-4">
					<div class="form-group">
                    <label>Size (BTU)</label>
				<input type="text" name="size" id="size" class="form-control input-lg" value="<?php echo $edit['size']; ?>" required tabindex="7">
					</div>
            	</div>
            </div> <!--row -->
            ...
            <div class="row">
				...
				<input type="text" name="brand" id="brand" class="form-control input-lg" value="<?php echo $edit['brand']; ?>" required tabindex="8">
					</div>
            	</div>
				...
				<input type="text" name="coo" id="coo" class="form-control input-lg" value="<?php echo $edit['coo']; ?>" required tabindex="9">
					</div>
            	</div>
           ...
           <h4 class="text-success">Examined By</h4>
           				...
           				<div class="form-group">
							...
							<input type="text" name="gra_officer" id="gra_officer" class="form-control input-lg" value="<?php echo $edit['gra_officer']; ?>" required tabindex="16">
						</div>
           
           
           				<div class="form-group">
                    		<label>Company Representative</label>
							<input type="text" name="representative" id="representative" class="form-control input-lg" value="<?php echo $edit['representative']; ?>" required tabindex="17">
						</div>
           </div>
             </div> <!--row -->     
             <hr/>
			...
			<hr class="colorgraph">
			<div class="row">
				<div><input type="submit" value="Edit/Save Record" class="btn btn-primary btn-block btn-lg" tabindex="19"></div>
			</div>
		</form>
	</div>
