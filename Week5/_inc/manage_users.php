...
foreach($results as $row){
    ...
    <td><?php if ($_SESSION['logged_in_user_id'] != $row['id'])
     { ?><a class="btn btn-xs btn-danger glyphicon glyphicon-trash" title="Delte User Information" href="#" onClick="linkRef('?manageusers=yes&del=<?php echo $row['id']; ?>')"></a> | <?php } ?>
         <a class="btn btn-xs btn-info glyphicon glyphicon-pencil" title="Edit User Information" href="?manageusers=yes&edit=<?php echo $row['id']; ?>"></a></td>
  </tr>
<?php        
}
?>
